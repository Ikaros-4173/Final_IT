...
using AsyncIO; // Librerias para socket
using NetMQ;
using NetMQ.Sockets;
using System.Threading;


//Aqui se declará clases para cliente y servidor entre python y UnityEngine

public class Client : MonoBehaviour // Clase para cliente
{
...
public class Requester : HiloCorredor //Clase de solicitante
{
    ...
    protected override void Correr()
    {
        ...
        {
            client.Connect("tcp://localhost:5200");
...
public abstract class HiloCorredor //CLase para hilos
{
    private readonly Thread _runnerThread;

    protected HiloCorredor()
    {
        ...
        _runnerThread = new Thread(Correr);
    }
...
public class PlayerMovement : MonoBehaviour // No tocar, clase para movimientos
{
